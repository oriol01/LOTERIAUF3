...
void printResults(colla *collaActual, arrPremios *numsPremios)
{
	...
	for(int i=0;i<collaActual->numpersones;i++)
	{
		...
		collaActual->import_total += collaActual->persones[i].premio;
		suma+=collaActual->persones[i].import;
	}

	printf("+======================================================+\n");
	printf("+------------------------------------------------------+\n");
    printf("|    ANY     | MEMBRES |    DINERS    |     PREMI      |\n");		// TODO tienen que ser modificables para que vaya en los distintos idiomas
	printf("+------------------------------------------------------+\n");		// TENEMOS QUE HACER LA SUMA TOTAL DE PREMIOS DE LA COLLA
    printf("|%-12d|%-9d|%-14d|%-16d|\n" , collaActual->ano,collaActual->numpersones, suma, collaActual->import_total);
	printf("+------------------------------------------------------+\n");
	printf("+======================================================+\n");
